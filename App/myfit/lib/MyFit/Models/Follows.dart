...
class Follows {
  ...
  List<MyFitProfile> _followings = [];
  List<MyFitProfile> _myFollowers = [];

  Follows([this._isFollow, this._followings, this._myFollowers]);

  List<MyFitProfile> get followings => _followings;

  set followings(List<MyFitProfile> value) {
    _followings = value;
  }
  ...
  List<MyFitProfile> get myFollowers => _myFollowers;

  set myFollowers(List<MyFitProfile> value) {
    _myFollowers = value;
  }
}
