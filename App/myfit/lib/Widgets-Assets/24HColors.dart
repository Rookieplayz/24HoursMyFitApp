...
class HColors {
  HColors._();
  ///Custom Colors Made by ollie
  static const int _midnightPrimaryValue=0xff19212b;
  static const Color mainscreenDark=const Color(0xff19212b);//const Color.fromRGBO(25, 33, 43, 1.0);
  static const Color midnightAccent=const Color(0xff017cd7);//const Color.fromRGBO(1, 124, 215, 1.0);
  static const Color midnightTextPrimary=const Color(0xffffbd07);//const Color.fromRGBO(255, 189, 7, 1.0);
  static const Color midnightTextSecnodary=const Color(0xff07b2ff);//const Color.fromRGBO(7,178,255,1.0);
  static const Color midnight_main= const Color(0xff263241);//const Color.fromRGBO(38, 50, 65, 1.0);
 
    static const int _daylightPrimaryValue=0xff004d40;
  static const Color daylightDark=const Color(0xfff9a825);//const Color.fromRGBO(25, 33, 43, 1.0);
  static const Color daylightAccent=const Color(0xfffdd835);//const Color.fromRGBO(1, 124, 215, 1.0);
  static const Color daylightTextPrimary=const Color(0xff000000);//const Color.fromRGBO(255, 189, 7, 1.0);
  static const Color daylightTextSecnodary=const Color(0xff07b2ff);//const Color.fromRGBO(7,178,255,1.0);
  static const Color daylight_main= const Color(0xfffffde7);//const Color.fromRGBO(38, 50, 65, 1.0);

      static const int _evePrimaryValue=0xff311b92;
  static const Color eveDark=const Color(0xff311b92);//const Color.fromRGBO(25, 33, 43, 1.0);
  static const Color eveAccent=const Color(0xffb388ff);//const Color.fromRGBO(1, 124, 215, 1.0);
  static const Color eveTextPrimary=const Color(0xfff9a825);//const Color.fromRGBO(255, 189, 7, 1.0);
  static const Color eveTextSecnodary=const Color(0xff000000);//const Color.fromRGBO(7,178,255,1.0);
  static const Color eve_main= const Color(0xffede7f6);//const Color.fromRGBO(38, 50, 65, 1.0);

  static const MaterialColor midnight = const MaterialColor(
      _midnightPrimaryValue,
      const <int, Color>{
  ...
  static const MaterialColor daylight = const MaterialColor(
    _daylightPrimaryValue,
    const <int, Color>{
