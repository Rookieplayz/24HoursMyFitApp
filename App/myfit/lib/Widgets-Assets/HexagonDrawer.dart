import 'package:flutter/material.dart';import 'package:twenty_four_hours/Widgets-Assets/polygon_path_drawer.dart';
...
class PolygonOutline extends StatefulWidget{
  ...
  final List<PolygonLine> polyLines;
  Size size;
  PolygonOutline(this.specs,this.polyLines,{this.size,this.width,this.color,this.capType,this.style});
  @override
  PolygonState createState()=>PolygonState(specs,polyLines,size:size,width:width,color: color,capType: capType,style: style);

}
class PolygonState extends State<PolygonOutline> with SingleTickerProviderStateMixin
{
  ...
  PolygonState(this.specs,this.polyLines,{this.size,this.width,this.color,this.capType,this.style});
  ...
  Widget build(BuildContext context) {
    return CustomPaint(painter: HexagonOutline(specs,polyLines,size:size,width:width,color: color,capType: capType,style: style));
  }
}
