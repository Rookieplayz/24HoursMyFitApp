...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  Image _image = Image.asset('assets/images/ic_rain.png');

  ParticleOptions particleOptions = ParticleOptions(
    image: Image.asset('assets/images/ic_rain.png'),
...
{
  ConfettiState createState()=>new ConfettiState();
}
class ConfettiState extends State<Confetti>with TickerProviderStateMixin
{
  @override
  Widget build(BuildContext context) {
